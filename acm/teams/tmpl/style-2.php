...
<div id="acm-teams-<?php echo $module->id; ?>" class="acm-teams style-2">
	<div class="acm-teams-inner">
    ...
    'button'
); ?>" class="btn btn-<?php echo $helper->get('btn-type'); ?> btn-sm">
				<p><?php echo $helper->get('button'); ?></p>
			</a>
			<?php endif; ?>
		</div>
	<?php endif; ?>
