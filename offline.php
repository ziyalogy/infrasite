...
<body class="offline-page">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="form-wrap col-12 col-xl-6">
          ...
          <form action="<?php echo JRoute::_('index.php', true); ?>" method="post" id="form-login">
            <fieldset class="input">
              ...
              <?php endif; ?>
              <p id="submit-buton">
                <input type="submit" name="Submit" class="btn button login" value="<?php echo JText::_('JLOGIN'); ?>" />
              </p>
        ...
        <div class="banner-wrap layer d-none d-xl-flex flex-column justify-content-end col-xl-6 p-0">
          ...
          <?php else: ?>
            <div class="offline-image">
              <img src="<?php echo $this->baseurl; ?>/images/joomlart/others/img-offline.png" alt="">
            </div>
          <?php endif; ?>
          
          <!-- Offline Slogan -->
          <blockquote  class="slogan blockquote">
            <img src="<?php echo $this->baseurl; ?>/images/joomlart/others/quote-left.png" alt="">
            <p><?php echo JText::_('TPL_OFFLINE_SLOGAN'); ?></p>
          </blockquote>      
        </div>
